          ...
          <ul className="mt-3 space-y-1 text-sm">
            <li>
              ...
              >
                ...
                <span className="text-(--text-soft) transition-colors group-hover:text-(--text)">邮箱</span>
                <span className="ml-auto hidden text-xs text-(--text-muted) group-hover:inline">hi@wjun.me</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="text-(--text-soft) transition-colors group-hover:text-(--text)">GitHub</span>
                <span className="ml-auto hidden text-xs text-(--text-muted) group-hover:inline">github.com/wjunex</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="text-(--text-soft) transition-colors group-hover:text-(--text)">个人简历</span>
                <span className="ml-auto hidden text-xs text-(--text-muted) group-hover:inline">wjun.me/resume</span>
              </a>
            </li>
          </ul>
        </div>
            ...
            <li>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <span className="ml-2 hidden text-xs text-(--text-muted) group-hover:inline">yangliuyiyi.com</span>
                  <p className="text-xs text-(--text-muted)">一起了解诗词历史</p>
                </div>
              </a>
            </li>
            <li>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <span className="ml-2 hidden text-xs text-(--text-muted) group-hover:inline">tab.zost.cn</span>
                  <p className="text-xs text-(--text-muted)">一款好用的浏览器插件</p>
                </div>
              </a>
            </li>
            <li>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <span className="ml-2 hidden text-xs text-(--text-muted) group-hover:inline">zost.cn</span>
                  <p className="text-xs text-(--text-muted)">一些有趣的网站和工具</p>
                </div>
              </a>
            </li>
          </ul>
