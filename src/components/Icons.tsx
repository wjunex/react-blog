...
export function HelpCircleIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="size-3.5">
      ...
      <path d="M6 6a2 2 0 0 1 2.5-1.85A2 2 0 0 1 9.93 6.5C9.93 8 8 8.5 8 9.5" />
...
export function ArrowUpIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="size-4">
      <path d="M8 14V3" />
      <path d="M3 7l5-5 5 5" />
    </svg>
  );
